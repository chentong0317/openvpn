...
wget https://github.com/chentong0317/openvpn/releases/download/v1.0.0/baihu_udp.zip -O baihu.zip
if [ $? -eq 0 ]; then
    echo "baihu 压缩包下载成功！"
else
...
sudo cp -r ./baihu/aws_ss_status_auto.sh /root/aws_ss_status_auto.sh
